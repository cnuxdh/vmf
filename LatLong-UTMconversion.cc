...
void LLtoUTM(int ReferenceEllipsoid, const double Lat, const double Long, 
			 double &UTMNorthing, double &UTMEasting, int ZoneNumber)
{
...
void UTMtoLL(int ReferenceEllipsoid, const double UTMNorthing, const double UTMEasting, int ZoneNumber,
